...
class GetInstanceGroupResult:
    ...
    """
    def __init__(__self__, additional_security_groups=None, additional_user_datas=None, associate_public_ip=None, autoscale=None, cloud_labels=None, cluster_name=None, compress_user_data=None, cpu_credits=None, detailed_instance_monitoring=None, external_load_balancers=None, file_assets=None, hooks=None, iams=None, id=None, image=None, instance_interruption_behavior=None, instance_metadatas=None, instance_protection=None, kubelets=None, machine_type=None, max_price=None, max_size=None, min_size=None, mixed_instances_policies=None, name=None, node_labels=None, role=None, rolling_updates=None, root_volume_delete_on_termination=None, root_volume_encryption=None, root_volume_encryption_key=None, root_volume_iops=None, root_volume_optimization=None, root_volume_size=None, root_volume_throughput=None, root_volume_type=None, security_group_override=None, spot_duration_in_minutes=None, subnets=None, suspend_processes=None, sysctl_parameters=None, taints=None, tenancy=None, update_policy=None, volume_mounts=None, volumes=None, warm_pools=None, zones=None):
        ...
        if root_volume_delete_on_termination and not isinstance(root_volume_delete_on_termination, bool):
            raise TypeError("Expected argument 'root_volume_delete_on_termination' to be a bool")
    ...
    def root_volume_delete_on_termination(self) -> bool:
...
class AwaitableGetInstanceGroupResult(GetInstanceGroupResult):
    ...
    def __await__(self):
        ...
        return GetInstanceGroupResult(
            ...
            root_volume_delete_on_termination=self.root_volume_delete_on_termination,
...
def get_instance_group(cluster_name: Optional[str] = None,
    ...
    return AwaitableGetInstanceGroupResult(
        ...
        root_volume_delete_on_termination=__ret__.root_volume_delete_on_termination,
