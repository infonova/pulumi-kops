...
class GetClusterResult:
    ...
    """
    def __init__(__self__, additional_network_cidrs=None, additional_policies=None, additional_sans=None, addons=None, admin_ssh_key=None, apis=None, assets=None, authentications=None, authorizations=None, aws_load_balancer_controllers=None, cert_managers=None, channel=None, cloud_configs=None, cloud_labels=None, cloud_provider=None, cluster_autoscalers=None, cluster_dns_domain=None, config_base=None, config_store=None, container_runtime=None, containerds=None, disable_subnet_tags=None, dns_zone=None, dockers=None, egress_proxies=None, encryption_config=None, etcd_clusters=None, external_cloud_controller_managers=None, external_dns=None, external_policies=None, file_assets=None, hooks=None, iams=None, id=None, isolate_masters=None, key_store=None, kube_api_servers=None, kube_controller_managers=None, kube_dns=None, kube_proxies=None, kube_schedulers=None, kubelets=None, kubernetes_api_accesses=None, kubernetes_version=None, master_internal_name=None, master_kubelets=None, master_public_name=None, metrics_servers=None, name=None, network_cidr=None, network_id=None, networkings=None, node_authorizations=None, node_port_accesses=None, node_problem_detectors=None, node_termination_handlers=None, non_masquerade_cidr=None, ntps=None, pod_cidr=None, project=None, rolling_updates=None, secret_store=None, secrets=None, service_account_issuer_discoveries=None, service_cluster_ip_range=None, snapshot_controllers=None, ssh_accesses=None, ssh_key_name=None, subnets=None, sysctl_parameters=None, topologies=None, update_policy=None, use_host_certificates=None, warm_pools=None):
        ...
        if disable_subnet_tags and not isinstance(disable_subnet_tags, bool):
            raise TypeError("Expected argument 'disable_subnet_tags' to be a bool")
        pulumi.set(__self__, "disable_subnet_tags", disable_subnet_tags)
    ...
    @property
    @pulumi.getter(name="disableSubnetTags")
    def disable_subnet_tags(self) -> bool:
        return pulumi.get(self, "disable_subnet_tags")
...
class AwaitableGetClusterResult(GetClusterResult):
    ...
    def __await__(self):
        ...
        return GetClusterResult(
            ...
            disable_subnet_tags=self.disable_subnet_tags,
...
def get_cluster(external_policies: Optional[Sequence[pulumi.InputType['GetClusterExternalPolicyArgs']]] = None,
    ...
    return AwaitableGetClusterResult(
        ...
        disable_subnet_tags=__ret__.disable_subnet_tags,
