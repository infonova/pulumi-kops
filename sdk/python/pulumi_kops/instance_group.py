...
class InstanceGroupArgs:
    def __init__(__self__, *,
                 ...
                 root_volume_delete_on_termination: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input['InstanceGroupKubeletArgs'] kubelet: - kubelet_config_spec - Kubelet overrides kubelet config from the ClusterSpec.
        ...
        :param pulumi.Input[bool] root_volume_delete_on_termination: - Bool - RootVolumeDeleteOnTermination is deprecated as of kOps 1.21 and has no effect.
        ...
        if root_volume_delete_on_termination is not None:
            pulumi.set(__self__, "root_volume_delete_on_termination", root_volume_delete_on_termination)
    ...
    def kubelet(self) -> Optional[pulumi.Input['InstanceGroupKubeletArgs']]:
        """
        - kubelet_config_spec - Kubelet overrides kubelet config from the ClusterSpec.
        """
    ...
    @property
    @pulumi.getter(name="rootVolumeDeleteOnTermination")
    def root_volume_delete_on_termination(self) -> Optional[pulumi.Input[bool]]:
        """
        - Bool - RootVolumeDeleteOnTermination is deprecated as of kOps 1.21 and has no effect.
        """
        return pulumi.get(self, "root_volume_delete_on_termination")

    @root_volume_delete_on_termination.setter
    def root_volume_delete_on_termination(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "root_volume_delete_on_termination", value)
...
class InstanceGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[bool] instance_protection: - Bool - InstanceProtection makes new instances in an autoscaling group protected from scale in.
        :param pulumi.Input[pulumi.InputType['InstanceGroupKubeletArgs']] kubelet: - kubelet_config_spec - Kubelet overrides kubelet config from the ClusterSpec.
        :param pulumi.Input[str] machine_type: - String - MachineType is the instance class.
        :param pulumi.Input[str] max_price: - String - MaxPrice indicates this is a spot-pricing group, with the specified value as our max-price bid.
        :param pulumi.Input[int] max_size: - Int - MaxSize is the maximum size of the pool.
        :param pulumi.Input[int] min_size: - Int - MinSize is the minimum size of the pool.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["root_volume_delete_on_termination"] = root_volume_delete_on_termination
    ...
    @property
    @pulumi.getter
    def kubelet(self) -> pulumi.Output[Optional['outputs.InstanceGroupKubelet']]:
        """
        - kubelet_config_spec - Kubelet overrides kubelet config from the ClusterSpec.
        """
        return pulumi.get(self, "kubelet")
    ...
    @property
    @pulumi.getter(name="rootVolumeDeleteOnTermination")
    def root_volume_delete_on_termination(self) -> pulumi.Output[Optional[bool]]:
        """
        - Bool - RootVolumeDeleteOnTermination is deprecated as of kOps 1.21 and has no effect.
        """
        return pulumi.get(self, "root_volume_delete_on_termination")
