...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 disable_subnet_tags: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[bool] disable_subnet_tags: - Bool - DisableSubnetTags controls if subnets are tagged in AWS.
        ...
        :param pulumi.Input['ClusterKubeletArgs'] kubelet: - kubelet_config_spec
        ...
        :param pulumi.Input['ClusterMasterKubeletArgs'] master_kubelet: - kubelet_config_spec
        ...
        :param pulumi.Input[str] network_cidr: - (Computed) - String - NetworkCIDR is the CIDR used for the AWS VPC / GCE Network, or otherwise allocated to k8s<br />This is a real CIDR, not the internal k8s network<br />On AWS, it maps to the VPC CIDR.  It is not required on GCE.
        ...
        if disable_subnet_tags is not None:
    ...
    def disable_subnet_tags(self) -> Optional[pulumi.Input[bool]]:
        """
        - Bool - DisableSubnetTags controls if subnets are tagged in AWS.
        """
        return pulumi.get(self, "disable_subnet_tags")

    @disable_subnet_tags.setter
    def disable_subnet_tags(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "disable_subnet_tags", value)
    ...
    def network_cidr(self) -> Optional[pulumi.Input[str]]:
        """
        - (Computed) - String - NetworkCIDR is the CIDR used for the AWS VPC / GCE Network, or otherwise allocated to k8s<br />This is a real CIDR, not the internal k8s network<br />On AWS, it maps to the VPC CIDR.  It is not required on GCE.
        """
...
class Cluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['ClusterKubeletArgs']] kubelet: - kubelet_config_spec
        :param pulumi.Input[Sequence[pulumi.Input[str]]] kubernetes_api_accesses: - List(String) - KubernetesAPIAccess is a list of the CIDRs that can access the Kubernetes API endpoint (master HTTPS).
        :param pulumi.Input[str] kubernetes_version: - String - The version of kubernetes to install (optional, and can be a "spec" like stable).
        :param pulumi.Input[str] master_internal_name: - (Computed) - String - MasterInternalName is the internal DNS name for the master nodes.
        :param pulumi.Input[pulumi.InputType['ClusterMasterKubeletArgs']] master_kubelet: - kubelet_config_spec
        :param pulumi.Input[str] master_public_name: - (Computed) - String - MasterPublicName is the external DNS name for the master nodes.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["disable_subnet_tags"] = disable_subnet_tags
    ...
    @property
    @pulumi.getter(name="disableSubnetTags")
    def disable_subnet_tags(self) -> pulumi.Output[Optional[bool]]:
        """
        - Bool - DisableSubnetTags controls if subnets are tagged in AWS.
        """
        return pulumi.get(self, "disable_subnet_tags")
